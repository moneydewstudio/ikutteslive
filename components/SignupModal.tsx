    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <div className="bg-white rounded-2xl w-full max-w-sm relative overflow-hidden shadow-2xl animate-fade-in-up">
        ...
        <div className="p-6 pt-8 text-center">
          ...
          <h2 className="text-xl font-bold text-gray-900 mb-2">Save your attempt</h2>
          <p className="text-gray-500 mb-6">Create a free account to track your improvement and unlock daily practice sets.</p>
